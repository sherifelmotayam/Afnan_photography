...
<body>
    ...
    <h1 class="tit"> Casual Events </h1>

    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="cas1.php">
                <img src="imagesGallery/c1.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="cas2.php">
                <img src="imagesGallery/c2.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="cas3.php">
                <img src="imagesGallery/c3.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="cas4.php">
                <img src="imagesGallery/c4.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
