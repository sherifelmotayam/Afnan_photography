...
include 'includes/class-autoloaded.php';
    if (isset($_POST['Add'])&&isset($_POST['idgallery']))
     {
        $idgallery=$_POST['idgallery'];
      $image=$_FILES['image']['name'];
     // print "<script>alert (' $ttt') </script>";
     if(empty($image)||empty($idgallery))
     {
      ...
      {
        $image =new images($image,"desc",$idgallery);
        $image->addimage();
      ...
      /*($Image_Name,$Image_Description,$Image_Type)
       ...
       <div class="drag-area">
        ...
        <div class="custom-select" style="width:300px;">
          ...
          <select name="idgallery">
              ...
              $gallery=new gallery("data","data","data");
              $getdata=$gallery->viewgalleryname();
              foreach ($getdata as $data)
                {

            ?>
             <option value="<?php echo($data['ID']); ?>"><?php echo($data['NameGallery']);?></option>
            <?php
          }
            ?>
</select>
        ...
        <div class="type">
            <label for="name"> Gallery name: </label> <br><br>
          
       </div>
       <h1 class="add "> Add Images </h1>
        <br> <br> <br> <br>
        <input type="submit" name="Add" class="next">
    </form>
    <script>
