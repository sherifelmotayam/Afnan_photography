...
class Packages extends conn
{
	...
	public function display()
	{
		...
		while($row=$stmt->fetch())
        {
          ...
          print "<a class='btn btn-danger' onclick='return confirm('Are you sure you want to delete this Reservartion')' style='position: absolute;' href='DeletePackages.php?id=".$row['ID']."'>Delete</a><td> ";
          print "<div>";
          print "</td>";
          print "</tr>";
        }
