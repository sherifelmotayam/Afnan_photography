...
<body width="600" height="600">
    ...
    <h1 class="tit"> Birthdays </h1>

    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="bir1.php">
                <img src="imagesGallery/b1.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="bir2.php">
                <img src="imagesGallery/b22.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="bir3.php">
                <img src="imagesGallery/b3.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="bir4.php">
                <img src="imagesGallery/b4.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
