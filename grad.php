<html>
<title> Graduations' gallery </title>
<head>
...
<body>
    ...
    <h1 class="tit"> Graduations </h1>

    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="grad1.php">
                <img src="imagesGallery/g1.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="grad2.php">
                <img src="imagesGallery/g2.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="grad3.php">
                <img src="imagesGallery/g3.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
