...
<center>
	<form method="POST" action="test2.php" style="margin-top: 30px;">
		<table style = "border-collapse: collapse; width:50%; border:1px solid black;">
          ...
          <th style = 'text-align: center; font-size:20px; border:1px solid black;'> Package Name </th>
          <th style = 'text-align: center; font-size:20px; border:1px solid black; width: 15%;'> Action </th>
         </tr>
	</form>
   <a href="AddPackage_Types.php" class='btn btn-primary' style="margin-left: 450px;margin-bottom: 20px;">Add</a>
</body>
</html>
<?php
$get=new Package_Type();
$get->display();
?>