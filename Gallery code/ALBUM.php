    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="Weddings.php">
                <img src="wed.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="Engagments.php">
                <img src="eng.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="birth.php">
                <img src="bbirth.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="grad.php">
                <img src="grad.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="Casual.php">
                <img src="CCasual.jpg" width="400" height="300">
            </a>
