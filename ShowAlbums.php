  ...
  <form method="POST" action="test2.php" style="margin-top: 30px;">
    <table style = "border-collapse: collapse; width:50%; border:1px solid black;">
      <tr> 
          ...
          <th style = 'text-align: center; font-size:20px; border:1px solid black;'> Album Name </th>
          <th style = 'text-align: center; font-size:20px; border:1px solid black;'>Image </th>
          <th style = 'text-align: center; font-size:20px; border:1px solid black; width: 15%;'> Action </th>
         </tr>
  </form>
   <a href="Addalbum.php" class='btn btn-primary' style="margin-left: 450px;margin-bottom: 20px;">Add<a>
</body>
</html>
<?php
$get=new album("a","a");
