...
<!--header begin-->
	...
	<div class="sidebar" style = 'margin-top: 0px;'>
        ...
        <a href="ShowBook.php"><i class="far fa-eye"></i><span>Show Booking</span></a>
        <a href="addalbum.php"><i class="fas fa-plus-circle"></i><span>Add Album</span></a>
        <a href="ShowAlbums.php"><i class="far fa-eye"></i><span>Show Albums</span></a>
        <a href="addGallery.php"><i class="fas fa-plus-circle"></i><span>Add Gallery</span></a>
        <a href="ShowGallery.php"><i class="far fa-eye"></i><span>Show Gallery</span></a>
        <a href="addImages.php"><i class="fas fa-plus-circle"></i><span>Add Images</span></a>
        <a href="ShowImages.php"><i class="far fa-eye"></i><span>Show Images</span></a>
        ...
        <a href="The_Main.php"><i class="fas fa-sign-out-alt"></i><span>log out</span></a>
