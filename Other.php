...
<body>
    ...
    <h1 class="tit"> Other Events </h1>

    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="oth1.php">
                <img src="o1.jpg" width="400" height="300">
            </a>
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank" href="oth2.php">
                <img src="o2.jpg" width="400" height="300">
            </a>
            <div class="desc"> Album, press to open </div>
        </div>
    </div>
